...
import { RefreshToken } from '../../server/src/models/RefreshToken';
import { hashToken } from '../../server/src/utils/crypto';
import { simulateEmail } from '../../server/src/utils/emailSimulation';
import { verifyAccessToken, verifyRefreshToken } from '../../server/src/utils/jwt';

vi.mock('../../server/src/utils/emailSimulation', () => ({ simulateEmail: vi.fn() }));
